...
class LoginTest extends PHPUnit_Framework_TestCase
{
    ...
    public function loginOldSite()
    {
        ...
        $oldSiteClient = new Zend_Http_Client('https://iep.unl.eduu/logon.php?option=1', $this->httpParams);
    ...
    public function loginIepweb02Site()
    {
        ...
        $newSiteClient = new Zend_Http_Client('https://iepweb02.unl.edu/login', $this->httpParams);
