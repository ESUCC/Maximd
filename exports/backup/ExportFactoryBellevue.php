...
//        $select->limit(10);
       ...
       //        print_r($exportLine);  
        ...
        $t=$exportLine[32];
          $exportLine[32]=substr($t,1,3995);
          $exportLine[32]=$exportLine[32];
          
          $t=$exportLine[31];
          $exportLine[31]=substr($t,1,3995);
          $exportLine[31]=$exportLine[31];
          
          $t=$exportLine[30];
          $exportLine[30]=substr($t,1,3995);
          $exportLine[30]=$exportLine[30];
          
          $t=$exportLine[29];
          $exportLine[29]=substr($t,1,3995);
          $exportLine[29]=$exportLine[29];
          
          $t=$exportLine[28];
          $exportLine[28]=substr($t,1,3995);
          $exportLine[28]=$exportLine[28];
          
          $t=$exportLine[27];
          $exportLine[27]=substr($t,1,3995);
          $exportLine[27]=$exportLine[27];
          
          $t=$exportLine[26];
          $exportLine[26]=substr($t,1,3995);
          $exportLine[26]=$exportLine[26];
          
          $t=$exportLine[25];
          $exportLine[25]=substr($t,1,3995);
