...
/**
 * jesselocal
    /usr/local/zend/bin/php-cli /usr/local/zend/apache2/htdocs/srs-zf/exports/GrandIsland/run_export.php jesselocal
 *
 * Production
    /usr/local/zend/bin/php /etc/httpd/srs-zf/exports/GrandIsland/run_export.php production
 */
...
require_once('GrandIsland/GrandIslandExport.php');
 ...
 */
$importFactory = new GrandIslandExport();
