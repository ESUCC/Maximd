        ...
        //     print_r($exportLine); // this prints the fields in array format.
          /*  * Array
            ...
            */
             // print_r($exportLine."   ");
       //        print_r($exportLine);  
            $exportLine[32]=$this->nssrsChangeValue($exportLine[30]);
              
            //$exportLine[2]=$this->changeTrueFalse($exportLine[2]);
              
             // $exportLine[9]=changeDateFormat($exportLine[9])
         //   $dateString=$exportLine[9];
            $exportLine[7] = $this->chDateFormat($exportLine[7]);
            $exportLine[8] = $this->chDateFormat($exportLine[8]);
            $exportLine[9] = $this->chDateFormat($exportLine[9]);

             
          $exportLine[18] = $this->chDateFormat($exportLine[18]);
          $exportLine[20] = $this->chDateFormat($exportLine[20]);
          $exportLine[21] = $this->chDateFormat($exportLine[21]);
          $exportLine[22] = $this->chDateFormat($exportLine[22]);  
          $exportLine[28] = $this->chDateFormat($exportLine[28]);
