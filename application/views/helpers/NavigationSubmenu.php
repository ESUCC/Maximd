...
class Zend_View_Helper_NavigationSubmenu extends Zend_View_Helper_Abstract
{
    ...
    public function navigationSubmenuStudent()
    {
        $session = new Zend_Session_Namespace ( 'user' );
        $this->returnText .= '<ul id="nav2">';
        $this->returnText .= '  <li><a href="https://iep.unl.eduu/srs.php?&area=student&sub=list">Student List</a></li>';
        if(!$session->parent) {
          //  $this->returnText .= '  <li '.(($actionName == 'studentadd') ? 'class="current"' : '').'><a href="/student/studentadd"><b><i><font color="green">New Student</a></font></b></i></li>';
           $this->returnText .= '  <li ><a href="/student/studentadd"><b><i><font color="green">New Student</a></font></b></i></li>';
            ...
            $this->returnText .= '  <li><a href="https://iep.unl.eduu/srs.php?&area=student&sub=student&option=new">New Student</a></li>';
            ...
            $this->returnText .= '  <li><a href="https://iep.unl.eduu/srs.php?&area=student&sub=admin">Student Admin</a></li>';
            $this->returnText .= '  <li><a href="https://iep.unl.eduu/srs.php?&area=student&sub=helper_pg">Progess Report Helper</a></li>';
            
         //   $this->returnText .= '  <li ><a href="https://iepweb02.unl.edu/ods/advisorset/id_county/87/id_district/0017"><b><i><font color="green">ODS Link</a></font></b></i></li>';
    ...
    public function navigationSubmenuPersonnel()
    {
        ...
        $this->returnText .= '<ul id="nav2">';
        $this->returnText .= '  <li><a href="https://iep.unl.eduu/srs.php?area=personnel&sub=list">Personnel List</a></li>';
        if(!$session->parent) {
            ...
            $this->returnText .= '  <li><a href="https://iep.unl.eduu/new_privilege.php?personnel='.$session->sessIdUser.'">New Privilege Request</a></li>';
...
// where appropriate
           ...
           $this->returnText .= '  <li ><a id="hideme" class="openWindow mike tooltip" data-tip-type="html" data-tip-source="tooltip-sidebar3"   title="var" href="https://iep.unl.eduu/new_privilege.php?personnel='.$session->sessIdUser.'"><font color="green"><b><i>New Privileges</font></b></i></a></li>';
            } 
// End of Mike add            
        }
        ...
        if($admin) {
            $this->returnText .= '  <li><a href="https://iep.unl.eduu/srs.php?&area=personnel&sub=admin">Personnel Admin</a></li>';
        }
        $this->returnText .= '</ul>';
        return $this->returnText;
    }
    public function navigationSubmenuHome()
    {
        ...
        if(!$session->parent) {
            ...
            $this->returnText .= '  <li><a href="https://iep.unl.eduu/new_privilege.php?personnel='.$session->sessIdUser.'">Announcements</a></li>';
            $this->returnText .= '  <li><a href="/personnel/edit/id_personnel/'.$session->sessIdUser.'">Edit Profile</a></li>';
//            $this->returnText .= '  <li><a href="https://iep.unl.eduu/new_privilege.php?personnel='.$session->sessIdUser.'">Password</a></li>';
