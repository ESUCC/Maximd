...
// Mike changed this back 7-31-2018 but going to use iepweb02 home screen
       // $this->returnText .= '  <li><a href="https://srsz3.nebraskacloud.org">Home</a></li>';
      //  $this->returnText .= '  <li><a href="https://iepdev.nebraskacloud.org/srs.php?area=home&sub=home">Home</a></li>';
        ...
        if(!$parent) {
            ...
            $this->returnText .= ' <li><a href="https://srsz3.nebraskacloud.org/personnel"><font color="green"><b><i>Staff Search</b></i></font></a></li>';
      ...
      //      $this->returnText .= '  <li '.(($controllerName == 'personnel') ? 'class="current"' : '').'><a href="https://iepdev.nebraskacloud.org/srs.php?area=personnel&sub=list">Personnel</a></li>';
            ...
            // SRS-269 Schools tab
            $this->returnText .= ' <li><a href="https://srsz3.nebraskacloud.org/school"><font color="green"><b><i>Schools</b></i></font></a></li>';
...
//
          ...
          //  $this->returnText .= '  <li><a href="https://srsz3.nebraskacloud.org/district"><font color="green"><b><i>Districts</a></i></b?</font></li>';
      ...
      //      $this->returnText .= '  <li><a href="https://iepdev.nebraskacloud.org/srs.php?area=district&sub=list">Districts</a></li>';
        ...
        //    $this->returnText .= '  <li><a href="https://iepdev.nebraskacloud.org/srs.php?area=admin&sub=server">Admin</a></li>';
            ...
            // SRS-269 reports tab
            $this->returnText .= '  <li><a href="https://srsz3.nebraskacloud.org/report">Reports</a></li>';
           ...
           // changed for SRS-269 8/6/2018 SI
            ...
            $this->returnText .= '  <li><a href="https://srsz3.nebraskacloud.org/help">Help</a></li>';
