...
class Zend_View_Helper_NavigationTopTabs extends Zend_View_Helper_Abstract
{
    ...
    public function navigationForms($controllerName, $admin, $parent=false)
    {
		...
		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=home&sub=home\');">Home</a></li>';
		...
		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=personnel&sub=list\');">Personnel</a></li>';

		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=school&sub=list\');">Schools</a></li>';

		// Mike changed this 4-3-2018 in an attemp to shut down iep
		//$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=district&sub=list\');">Districts</a></li>';
		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https:/district\');">Districts</a></li>';


		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=admin&sub=server\');">Admin</a></li>';
		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=reports&sub=reports\');">Reports</a></li>';
		$this->returnText .= '  <li><a href="javascript:checkEditedStatus(\'https://iep.nebraskacloud.orgu/srs.php?area=help&sub=tutorials\');">Help</a></li>';
    ...
    public function navigationSimple($controllerName, $admin, $parent=false)
    {
        ...
        $this->returnText .= '  <li><a href="https://iep.nebraskacloud.orgu/srs.php?area=home&sub=home">Home</a></li>';
        ...
        if(!$parent) {
            ...
            $this->returnText .= '  <li '.(($controllerName == 'personnel') ? 'class="current"' : '').'><a href="https://iep.nebraskacloud.orgu/srs.php?area=personnel&sub=list">Personnel</a></li>';

            $this->returnText .= ' <li><a href="https://iepweb02.nebraskacloud.org/school/search"><font color="green"><b><i>Schools</b></i></font></a></li>';
            $this->returnText .= '  <li><a href="https://iep.nebraskacloud.orgu/srs.php?area=school&sub=list">Schools</a></li>';

            $this->returnText .= '  <li><a href="/district"><font color="green"><b><i>Districts</a></i></b?</font></li>';
         //   $this->returnText .= '  <li><a href="https://iep.nebraskacloud.orgu/srs.php?area=district&sub=list">Districts</a></li>';
            $this->returnText .= '  <li><a href="/district">Districts</a></li>';

            $this->returnText .= '  <li><a href="https://iep.nebraskacloud.orgu/srs.php?area=admin&sub=server">Admin</a></li>';
            $this->returnText .= '  <li><a href="/report">Reports</a></li>';
            $this->returnText .= '  <li><a href="https://iep.nebraskacloud.orgu/srs.php?area=help&sub=tutorials">Help</a></li>';
