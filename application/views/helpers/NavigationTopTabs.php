...
class Zend_View_Helper_NavigationTopTabs extends Zend_View_Helper_Abstract
{
    ...
    public function navigationSimple($controllerName, $admin, $parent=false)
    {
        ...
        if(!$parent) {
            ...
            $this->returnText .= ' <li><a href="https://iepweb02.esucc.org/personnelm"><font color="green"><b><i>Personnel</b></i></font></a></li>';
            ...
            $this->returnText .= ' <li><a href="https://iepweb02.esucc.org/school/search"><font color="green"><b><i>Schools</b></i></font></a></li>';
