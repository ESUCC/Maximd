...
class Form_Form029OutsideAgency extends Form_AbstractForm {
	
	private $JSmodifiedCode = "javascript:modified('', '', '', '', '', '');";
	
	public function outside_agency_edit_version11() {
	    return $this->outside_agency_edit_version1();
	}
	
	public function outside_agency_edit_version10() {
	    return $this->outside_agency_edit_version1();
	}
	...
	public function outside_agency_edit_version1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/outside_agency_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->id_form_029_agency_representitive = new App_Form_Element_Hidden('id_form_029_agency_representitive');
