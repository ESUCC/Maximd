...
class Form_Form003OutsideAgency extends Form_AbstractForm {
	...
	public function outside_agency_edit_version1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form003/outside_agency_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->id_form_003_agency_representitive = new App_Form_Element_Hidden('id_form_003_agency_representitive');
