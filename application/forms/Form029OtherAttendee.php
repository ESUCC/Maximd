...
class Form_Form029OtherAttendee extends Form_AbstractForm {
	
	private $JSmodifiedCode = "javascript:modified('', '', '', '', '', '');";
	
	public function other_attendee_edit_version11() {
	    return $this->other_attendee_edit_version1();
	}
	
	public function other_attendee_edit_version10() {
	    return $this->other_attendee_edit_version1();
	}
    ...
    public function other_attendee_edit_version1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/other_attendee_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->subform_label->setLabel("Other Attendee");
                
        $this->id_form_029_other_attendee = new App_Form_Element_Hidden('id_form_029_other_attendee', array('label'=>''));
	...
	public function subform_header_edit_version9($subformName, $addNotReq = false) {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/other_attendee_header.phtml' ) ) ) );
