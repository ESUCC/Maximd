...
class Form_Form029GenEdTeacher extends Form_AbstractForm {
	
	private $JSmodifiedCode = "javascript:modified('', '', '', '', '', '');";
	
	public function gen_ed_teacher_edit_version11() {
	    return $this->gen_ed_teacher_edit_version1();
	}
	
	public function gen_ed_teacher_edit_version10() {
	    return $this->gen_ed_teacher_edit_version1();
	}
    public function gen_ed_teacher_edit_version9() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version8() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version7() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version6() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version5() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version4() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version3() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version2() {
        return $this->gen_ed_teacher_edit_version1();
    }
    public function gen_ed_teacher_edit_version1() {

		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/gen_ed_teacher_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->subform_label->setLabel("A general education teacher of your child:");
                
        $this->id_form_029_gen_ed_teacher = new App_Form_Element_Hidden('id_form_029_gen_ed_teacher', array('label'=>''));
	...
	public function subform_header_edit_version9($subformName, $addNotReq = false) {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/gen_ed_teacher_header.phtml' ) ) ) );
