...
class Form_SearchForm extends Zend_Form {
 ...
 // Mike changed this 3-11-2017 as per SRS 50    
//   "032" => array( "fullName" => "Notice of Meeting (IFSP)", "shortName" => "Notice of Meeting (IFSP)", 'date' => "date_notice" ),
        "032" => array( "fullName" => "Notice of Meeting (Part C)", "shortName" => "Notice of Meeting (Parct C", 'date' => "date_notice" ),
    ...
    public function init()
    {
        $this->formType = new App_Form_Element_SearchSelect(
            ...
            array(
                ...
                'multiOptions' => array(
                    ...
                    'PART C FORMS' => array(
                        '013' => "IFSP",
                       // Mike changed this 3-11-2017 srs 50
     ...
     //   $this->writevar1($this->formCreateType,'the form creation type ');
     //   $this->writevar1($createForms,'this is the createForms variable');
    ...
    private function getCreateFormsOptions()
    {
        $createForms = array(
            ...
            'PART B FORMS' => array(
                ...
                '026' => "Revocation of Consent for Special Education and Related Services",
                '028' => "Equitable Service Plan",
                '030' => "Notice of Equitable Service Meetings",
                '034' => "Prior Written Notice",
