...
class Form_Form029ContactAttempts extends Form_AbstractForm {
	...
	public function contact_attempts_edit_version11() {
	    return $this->contact_attempts_edit_version1();
	}
	
	public function contact_attempts_edit_version10() {
	    return $this->contact_attempts_edit_version1();
	}
    ...
    public function contact_attempts_edit_version1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/contact_attempts_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->id_form_029_contact_attempts = new App_Form_Element_Hidden('id_form_029_contact_attempts', array('label'=>''));
	...
	public function subform_header_edit_version9($subformName, $addNotReq = false) {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/contact_attempts_header.phtml' ) ) ) );
