...
class Form_Form034 extends Form_AbstractForm {
	...
	$this->date_notice->setRequired(true);
        ...
        $this->is_district_action = new Zend_Form_Element_Radio('is_district_action');
        $this->is_district_action->addMultiOptions(array('1' => 'proposes','0' => 'refuses'))->setSeparator('');
        $this->is_district_action->setDecorators(array(array('ViewHelper')));

        $this->are_other_factors = new Zend_Form_Element_Radio('are_other_factors');
        $this->are_other_factors->addMultiOptions(array('1' => 'proposal', '0' => 'refusal'))->setSeparator('');
        $this->are_other_factors->setDecorators(array(array('ViewHelper')));
