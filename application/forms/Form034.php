...
class Form_Form034 extends Form_AbstractForm {
	...
	//	$this->date_delivery =  new App_Form_Element_Text('date_delivery',array('label'=>'Date of Delivery'));
		$this->date_delivery = new App_Form_Element_DatePicker('date_delivery', array('label'=>'Date of Delivery'));
		$this->date_delivery->setDecorators(App_Form_DecoratorHelper::inlineElement(false));
		$this->date_delivery->addErrorMessage("Date of Delivery is empty.");
		$this->date_delivery->setAttrib('onchange', $this->JSmodifiedCode . "colorMeById(this.id, 'dates_wrapper');");
		$this->date_delivery->setAllowEmpty(false);
		$this->date_delivery->setRequired(true);





		$this->method_delivery = new App_Form_Element_Select('method_delivery');
		$this->method_delivery->setLabel('Method of Delivery');
		//$this->method_delivery->getDecorator('label')->setOption('class', 'srsLabel');
		$this->method_delivery->setRequired(true);
		$this->method_delivery->setMultiOptions(array(
		    ''=>'Choose...',
		    'A' =>'Hand Delivered',
		    'B' =>'Postal Mail',
		    'C'=>'E-mail',
