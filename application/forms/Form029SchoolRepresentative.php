...
class Form_Form029SchoolRepresentative extends Form_AbstractForm {
	
	private $JSmodifiedCode = "javascript:modified('', '', '', '', '', '');";
	
	public function school_representative_edit_version11() {
	    return $this->school_representative_edit_version1();
	}
	
	public function school_representative_edit_version10() {
	    return $this->school_representative_edit_version1();
	}
    public function school_representative_edit_version9() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version8() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version7() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version6() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version5() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version4() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version3() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version2() {
        return $this->school_representative_edit_version1();
    }
    public function school_representative_edit_version1() {

		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/school_representative_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->subform_label->setLabel("A school representative:");
                
        $this->id_form_029_school_representative = new App_Form_Element_Hidden('id_form_029_school_representative', array('label'=>''));
	...
	public function subform_header_edit_version9($subformName, $addNotReq = false) {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/school_representative_header.phtml' ) ) ) );
