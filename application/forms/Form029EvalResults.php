...
class Form_Form029EvalResults extends Form_AbstractForm {
	
	private $JSmodifiedCode = "javascript:modified('', '', '', '', '', '');";
	
	public function eval_results_edit_version11() {
	    return $this->eval_results_edit_version1();
	}
	
	public function eval_results_edit_version10() {
	    return $this->eval_results_edit_version1();
	}
    public function eval_results_edit_version9() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version8() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version7() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version6() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version5() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version4() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version3() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version2() {
        return $this->eval_results_edit_version1();
    }
    public function eval_results_edit_version1() {

		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/eval_results_edit_version1.phtml' ) ) ) );
		//
        ...
        $this->subform_label->setLabel("Individuals who can help explain the evaluation results:");
                
        $this->id_form_029_eval_results = new App_Form_Element_Hidden('id_form_029_eval_results', array('label'=>''));
	...
	public function subform_header_edit_version9($subformName, $addNotReq = false) {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/eval_results_header.phtml' ) ) ) );
