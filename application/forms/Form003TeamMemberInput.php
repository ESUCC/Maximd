...
class Form_Form003TeamMemberInput extends Form_AbstractForm {
	...
	public function team_member_input_edit_version1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form003/team_member_input_edit_version1.phtml' ) ) ) );
		//
