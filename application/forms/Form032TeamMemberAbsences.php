...
class Form_Form032TeamMemberAbsences extends Form_AbstractForm {
	...
	public function team_member_absences_edit_version1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form032/team_member_absence_edit_version1.phtml' ) ) ) );
		//
