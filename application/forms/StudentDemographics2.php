...
class Form_StudentDemographics2 extends Form_AbstractForm {

    
   public function writevar($var1,$var2) {
...
//        $this->sesis_exit_date->addValidator(new My_Validate_NotEmptyIf('status', 'Never Qualified'));
        ...
        $this->name_case_mgr = new App_Form_Element_Text('name_case_mgr',array('label' =>'Case Manager'));
        $this->name_case_mgr->setIgnore(true);
        $this->name_case_mgr->setAllowEmpty(false);
        $this->name_case_mgr->setRequired(false);
        $this->name_case_mgr->setAttrib('readonly', 'readonly');
        
        $this->id_case_mgr = new Zend_Form_Element_Hidden('id_case_mgr');
        $this->id_case_mgr->setAttrib('readonly', 'readonly');
        /*
   ...
   */
        ...
        /*
        $this->id_case_mgr = new App_Form_Element_Text('id_case_mgr', array('label' => 'Case Manager'));
        $this->id_case_mgr->setAttrib('readonly', 'readonly');
        */
...
//        $this->parental_placement->setSeparator('<br>');
        ...
        $this->parental_placement->setMultiOptions(array(
            2 => 'Nonpublic Placement - Parental Placement, Special Education Services from Resident District, Student on Equitable Service Plan',
            1 => 'Nonpublic Placement - Parental Placement, Special Education Services from Resident District, Student on IEP',
            0 => 'Nonpublic Placement - Other than Parental Placement'
        ));
...
//        }
        ...
        //   );
            ...
            /*$t=$personnelTable->getCaseManagers($studentData['id_county'], $studentData['id_district'], $studentData['id_school']);
            writevar($studentData['id_case_mgr'], 'the id of the case manager');
            writevar($t,'here they are ');// associative array ['id_personn']=>"Name of Personnel" */
        }
        /**
