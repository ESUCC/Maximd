...
class Form_Form010 extends Form_AbstractForm {
	...
	protected function initialize() {
		...
		$this->id_form_010 = new App_Form_Element_Hidden('id_form_010');
      	$this->id_form_010->ignore = true;
	...
	public function view_p1_v1() {
		$this->initialize();
		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form010/form010_view_page1_version1.phtml' ) ) ) );
		return $this;
	}
	...
	public function edit_p1_v1() {
		...
		$this->setDecorators ( array (array ('ViewScript', array (
										'viewScript' => 'form010/form010_edit_page1_version1.phtml' ) ) ) );
