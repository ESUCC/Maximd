...
class Form_ReportNssrs extends Form_AbstractForm
{
    ...
    public function buildFormOptions($formData)
    {
        ...
        $options = array(
            '0' => 'Public School (0)',
            '1' => 'Nonpublic Placement - Parental Placement (1)', // no longer used
            '2' => 'Nonpublic Placement - Other than Parental Placement (2)',
            '3' => 'Nonpublic Placement - Parental Placement, Special Education Services from Resident District, Student on IEP (3)',
            '4' => 'Nonpublic Placement - Parental Placement, Special Education Services from Resident District, Student on Equitable Service Plan (4)',
        );
    ...
    public function buildReport($readonly = true)
    {
        ...
        $this->field32->addValidator('Between', false, array(0, 4));
