...
class Form_Form029TeamMemberInput extends Form_AbstractForm {
	...
	public function team_member_input_edit_version10() {
	    return $this->team_member_input_edit_version1();
	}
	public function team_member_input_edit_version11() {
	    return $this->team_member_input_edit_version1();
	}
	public function team_member_input_edit_version1() {

		$this->setDecorators ( array (array ('ViewScript', array ('viewScript' => 'form029/team_member_input_edit_version1.phtml' ) ) ) );
		//
