...
class Form008Controller extends My_Form_AbstractFormController {
    ...
    public function init(){
        ...
        parent::setPrimaryKeyName('id_form_008');
        parent::setFormNumber('008');
        parent::setModelName('Model_Form008');
        parent::setFormClass('Form_Form008');
        parent::setFormTitle('Notice of Change of Placement');
