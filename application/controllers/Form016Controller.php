...
class Form016Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_016');
        parent::setFormNumber('016');
        parent::setModelName('Model_Form016');
        parent::setFormClass('Form_Form016');
        parent::setFormTitle('Notice and Consent for Initial Placement (IFSP)');
