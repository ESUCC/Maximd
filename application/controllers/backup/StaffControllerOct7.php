   ...
   //   writevar($StudentsOfTeamMember,'this is the array');
    ...
    public function teamAction() 
    {
     include("Writeit.php");
      ...
      // writevar($studentId,'after it checks this is the student id');
        ...
        $this->view->districtList=$staffList;
        //writevar(count($staffList),'this is the staff list count');
       // end of the student to be displayed at top of second column.
      
        
       

        
        // This get information on one student and displays it in the second column as "Student:<student name>" which then lists the team members.
        //Mike D 9-29-2016
