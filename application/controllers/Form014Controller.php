...
class Form014Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_014');
        parent::setFormNumber('014');
        parent::setModelName('Model_Form014');
        parent::setFormClass('Form_Form014');
        parent::setFormTitle('Notification of Individualized Family Service Plan');
...
//		}
    ...
    {
	//Automatically fill in a few fields in form 14, based on the student's information!
	$studentObj = new Model_Table_ViewAllStudent();
        ...
        $current = $form014Obj->find($newId)->current();
