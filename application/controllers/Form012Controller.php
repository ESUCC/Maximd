...
class Form012Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_012');
        parent::setFormNumber('012');
        parent::setModelName('Model_Form012');
        parent::setFormClass('Form_Form012');
        parent::setFormTitle('Notice That No Additional Information Is Needed To Determine Continued Eligibility');
