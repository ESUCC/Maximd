...
// Maxim modified this code October 20 2016
    ...
    public function parentAction()
    {
        ...
        header("Location:https://iep.unl.eduu/srs.php?area=student&sub=student&student=".$request->id_student."&option=parents");
        exit;
    }
...
//        $this->_helper->layout()->disableLayout();
    ...
    public function teamAction()
    {
        ...
        //header("Location:https://iep.unl.eduu/srs.php?area=student&sub=student&student=".$request->id_student."&option=team");
        exit;
    ...
    public function chartsAction()
    {
        ...
        header("Location:https://iep.unl.eduu/srs.php?area=student&sub=student&student=".$request->id_student."&option=charting");
        exit;
    ...
    public function editAction()
    {
        ...
        //    $this->writevar1($studentArr,'this is the student array');//this gets demo of student as well as firstnamme,lastname of teacm members.  T
           ...
           $this->view->id_student = $this->getRequest()->getParam('id_student');
            ...
            $url = Zend_Controller_Request_Http::SCHEME_HTTPS . "://iep.unl.eduu/srs.php?area=student&sub=student&student=".$dbStudent['id_student']."&option=edit";
