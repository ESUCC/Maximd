...
// Maxim modified this code October 20 2016
    ...
    public function parentAction()
    {
        ...
        header("Location:https://iepdev.nebraskacloud.org/srs.php?area=student&sub=student&student=".$request->id_student."&option=parents");
        exit;
    }
...
//        $this->_helper->layout()->disableLayout();
    ...
    public function teamAction()
    {
        ...
        //header("Location:https://iepdev.nebraskacloud.org/srs.php?area=student&sub=student&student=".$request->id_student."&option=team");
        exit;
    ...
    public function chartsAction()
    {
        ...
        header("Location:https://iepdev.nebraskacloud.org/srs.php?area=student&sub=student&student=".$request->id_student."&option=charting");
        exit;
    ...
    public function editAction()
    {
        ...
        //    $this->writevar1($studentArr,'this is the student array');//this gets demo of student as well as firstnamme,lastname of teacm members.  T
           ...
           $this->view->id_student = $this->getRequest()->getParam('id_student');
            ...
            $url = Zend_Controller_Request_Http::SCHEME_HTTPS . "://iepdev.nebraskacloud.org/srs.php?area=student&sub=student&student=".$dbStudent['id_student']."&option=edit";
...
// Mike added this 11-10-2017 in order to get data to edfi on edit student changes
                    ...
                    $ps=$data['sesis_exit_code'];

                    if(strlen($ps)==1){
                        $ps="0".$ps;
                        $data['sesis_exit_code'] =$ps;
                    }

                    $dataEdfi=$data;
                    $dataEdfi['id_student']=$this->getRequest()->getParam('id_student');
                   // $this->writevar1($dataEdfi,'this is the edfi data line 1164 in student controller');
...
//        Zend_Debug::dump($collectionItems);die;
    ...
    function groupRemoveAction() {
        ...
        $this->writevar1($groupName,'this is the group name');
        if(''!=$studentId) {
