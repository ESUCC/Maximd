...
class Form031Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_031');
        parent::setFormNumber('031');
        parent::setModelName('Model_Form031');
        parent::setFormClass('Form_Form031');
        parent::setFormTitle('Notice of Initial Evaluation and Child Assessment');
