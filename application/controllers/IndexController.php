...
//MIKE
    	...
    	if('production' == APPLICATION_ENV) {
    		$this->_redirect('https://iepd.nebraskacloud.org/');
    	}
    	$this->restoreMessage();
...
//        echo 'frank1';die();
    ...
    public function loginredirectAction() {
		...
		if('' != $token) {
			...
			// this is the session record for the iepd.nebraskacloud.org site
...
//	    		}
	    		...
	    		return $this->_redirect('https://iepd.nebraskacloud.org/srs.php?area=personnel&sub=gettoken&destination='.$this->getRequest()->getParam('destination'));
	    	} else {
        ...
        if($this->getRequest()->getParam('destination')) {
    		...
    		$this->_redirect('https://iepd.nebraskacloud.org/srs.php?area=home&sub=home&option=1');
    	} else {
    		$this->_redirect('/home');
    	}
