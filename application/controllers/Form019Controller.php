...
class Form019Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        $this->view->pageCount = 1;
            ...
            parent::setPrimaryKeyName('id_form_019');
        parent::setFormNumber('019');
        parent::setModelName('Model_Form019');
        parent::setFormClass('Form_Form019');
        parent::setFormTitle('Functional Assessment');
