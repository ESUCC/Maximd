...
class Form009Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_009');
        parent::setFormNumber('009');
        parent::setModelName('Model_Form009');
        parent::setFormClass('Form_Form009');
        parent::setFormTitle('Notice of Discontinuation of Special Education Services');
