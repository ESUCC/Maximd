...
class Form034Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_034');
        parent::setFormNumber('034');
        parent::setModelName('Model_Form034');
        parent::setFormClass('Form_Form034');
