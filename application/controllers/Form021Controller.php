...
class Form021Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        $this->view->pageCount = 1;
            ...
            parent::setPrimaryKeyName('id_form_021');
        parent::setFormNumber('021');
        parent::setModelName('Model_Form021');
        parent::setFormClass('Form_Form021');
        parent::setFormTitle('Assistive Technology Considerations');
