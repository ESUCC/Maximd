...
{
    // Mike on commit 12-12-2016 and 12/7/2017 adn May 2
// June 10th lat commit
    ...
    function testprintAction1() {
      ...
      //  $filename='/usr/local/zend/var/apps/https/iepweb02dev.nebraskacloud.org/443/1.0.0_268/srs-form-archive/NewRoot/01/0018/003/2012/1130587/1130587-002-1206342-archived(20121227).pdf';
   ...
   //     $this->_helper->viewRenderer->setNoRender(true);
    ...
    function testprintAction() {
        ...
        $filename='/usr/local/zend/var/apps/https/iepweb02dev.nebraskacloud.org/443/1.0.0_268/srs-form-archive/NewRoot/';
        // $filename=$path.'/'.$file;
        $pdf1=new Zend_Pdf;
    ...
    public function makeJqueryArray($data) {
        ...
        foreach($data as $key => $val) {
            ...
            // Mike added this 5-9-2018 because certain pages were erroring out.

            //  $val['edfierrormessage']=' ';
            $val['edfierrormessage'] =str_replace(array('.', ',','\''), '' , $val['efierrormessage']);
