...
// June 10th lat commit
    ...
    public function indexAction()   
    {
        ...
        $data1 = $iep_district->fetchAll($iep_district->select()->order("name_district"));
        ...
        if ($this->getRequest()->isPost()) {
          ...
          // Decide 
            ...
            if ($form->isValid($formData)) {
              ...
              //  writevar($formData,'this is the form data');
            } */
        } else {
            ...
            //   writevar($disTable,'this is the array');
                if($proceed=='yes'){
    ...
    function viewAction()
    {
     ...
     //  $acctManager = $nameManager->fetchRow($nameManager->select()->order($field));
       ...
       if ($this->getRequest()->isPost()) {
         ...
         //   writevar($name_district,'this is the district name');
   ...
   // 
    ...
    public function disAbleLayout()
    {
      ...
      */
        ...
        // writevar($staffMembers,'here they are \n');
