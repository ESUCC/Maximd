...
class StudentController extends My_Form_AbstractFormController
{
    ...
    public function studentaddAction()
    {
        ...
        $result = $studentAddFormQuery->studentFormAdd($options); // Get result
        $this->view->county = $result[0]['name_county'];
        $this->view->district = $result[1]['name_district'];
        $this->view->school_list = $result[2];
