...
class Form020Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        $this->view->pageCount = 1;
            ...
            parent::setPrimaryKeyName('id_form_020');
        parent::setFormNumber('020');
        parent::setModelName('Model_Form020');
        parent::setFormClass('Form_Form020');
        parent::setFormTitle('Specialized Transportation');
