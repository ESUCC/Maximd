...
class Form006Controller extends My_Form_AbstractFormController {
    ...
    public function init() {
        ...
        parent::setPrimaryKeyName('id_form_006');
        parent::setFormNumber('006');
        parent::setModelName('Model_Form006');
        parent::setFormClass('Form_Form006');
        parent::setFormTitle('Notice of School District&rsquo;s Decision Regarding Requested Special Education Services');
