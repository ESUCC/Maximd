...
//	echo $request->id_personnel."|".$request->id_county."|".$request->id_district."|".$request->id_school."|".$request->class;
        ...
        if($okToSave==true) {
          ...
          // echo $this->url(array('controller'=>'personnelm','action'=>'edit','id_personnel',$request->id_personnel));
             ...
             echo '<center><a href="https://iepweb02.nebraskacloud.org/personnelm/edit/id_personnel/'.$request->id_personnel.'">Saved Privileges--Click to Continue</a>';
           // $this->_redirect('https://iepweb02.nebraskacloud.org/personnelm/edit/id_personnel/'.$request->id_personnel);
           }
