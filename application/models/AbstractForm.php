...
//        Zend_Debug::dump($this->db_form_data);die();
	...
	public function finalizeForm($id)
	{
		...
		try {
			...
			//$this->writevar1($currentForm,'this is current form in abstractform model line 319');
			...
			/*
			 * we can catch all forms here
			 * Mike 6-12-2017
			 */
			//$this->writevar1($currentForm,'this is the current form line 326');
			//$this->writevar1($formTable,'this is the form table line 327');
			//$this->writevar1($studentArr,'this is the student array line 328');
...
//    	print_r($data);die();
    ...
    {
        $this->writevar1($pkName,'this is the pkname');
    ...
    function deleteFormInsert($pkeyName, $document, $formNum) {
       //  die(); // Mike 3-14-2017
    	...
    	// $this->writevar1($row,'this is the row from the document'); returns form data 
