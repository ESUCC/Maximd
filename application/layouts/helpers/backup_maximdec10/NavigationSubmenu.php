...
class Zend_View_Helper_NavigationSubmenu extends Zend_View_Helper_Abstract
{
    ...
    public function navigationSubmenuStudent($actionName, $submenu = '' )
    {
        ...
        if(!$session->parent) {
            ...
            $this->returnText .= '  <li><a href="https://iepweb03.esucc.org/staff">Student\'s  Team</a></li>';
            $this->returnText .= '  <li><a href="https://iepweb03.esucc.org/staff/index2">Team\'s Students</a></li>';
