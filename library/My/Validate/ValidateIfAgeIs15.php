 ...
 */
class My_Validate_ValidateIfAgeIs15 extends Zend_Validate_Abstract {
  ...
  public function isValid($value, $context = null) {
    ...
    if (empty($value) && $olderThan15)
    {
        echo 'value = ' . $value . ' and setting false';
        exit;
        return false;
    }
    else
    {
        echo 'value = ' . $value . ' and setting true';
        exit;
        return false;
    }
  }
