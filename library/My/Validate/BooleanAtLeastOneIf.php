 ...
 * @author   Jesse LaVere
 */
class My_Validate_BooleanAtLeastOneIf extends Zend_Validate_Abstract {
   ...
   */
  public function __construct($parentFieldName, $matchValue = null, $notEmptyFieldNames = null) {
