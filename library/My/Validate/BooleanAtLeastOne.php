 ...
 * @author   Jesse LaVere
 */
class My_Validate_BooleanAtLeastOne extends Zend_Validate_Abstract {
   ...
   */
  public function __construct($matchValue = null, $notEmptyFieldNames = null) {

    //$this->setValueOne($parentFieldName);
    $this->setValueTwo($matchValue);
    $this->setValueThree($notEmptyFieldNames);
  }
  /**
...
//		Zend_debug::dump($rowDataArray[$fieldName]);
  ...
  protected function getValueThree () {
    return $this->_notEmptyFieldNames;
  }
 
  /**
   * @param string $notEmptyFieldNames
   */
  protected function setValueThree ($notEmptyFieldNames) {
    $this->_notEmptyFieldNames = $notEmptyFieldNames;
  }
