...
class My_Validate_Form013TransitionPlan extends Zend_Validate_Abstract {
  ...
  public function isValid($value, $context = null) {
    ...
    if (is_array($context[$contextKey])) {
      ...
      $overrideCheckbox = $context['transition_plan'][0];
    } else {
      $parentField = $context[$contextKey];
      $overrideCheckbox = $context['transition_plan'];
    }
    ...
    // override checkbox
    if(null === $overrideCheckbox || 0 === $overrideCheckbox || '0' == $overrideCheckbox) {
    	return true;
    }
