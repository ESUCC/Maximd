 ...
 * @author Jeremy Kendall
 */
class My_Validate_EditorEmpty extends Zend_Validate_Abstract {
	
	/**
	 * Validation failure message key for when the value of the parent field is
	 * an empty string
	 */
	...
	/**
	 * Returns true if dependant field value is not empty when parent field
	 * value
