 ...
 * @author   Jeremy Kendall 
 */
class My_Validate_IFSPParentSigs extends Zend_Validate_Abstract {
  ...
  public function doValid($value, $context = null) {
      ...
      $test1 = (!is_null($context['parent_sig_1_on_file']) && 0===intval($context['parent_sig_1_on_file']))?true:false;
      $test2 = (!is_null($context['parent_sig_2_on_file']) && 0===intval($context['parent_sig_2_on_file']))?true:false;
    if(($test1 || $test2) && ''==$context['parent_sig_on_file_explain']) {
