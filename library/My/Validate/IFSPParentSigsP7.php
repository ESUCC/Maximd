 ...
 * @author   Jeremy Kendall 
 */
class My_Validate_IFSPParentSigsP7 extends Zend_Validate_Abstract {
  ...
  const SIG_NOT_ON_FILE = 'sigNotOnFile';
  ...
  protected $_messageTemplates = array(
	...
	self::SIG_NOT_ON_FILE => 'Please explain when a parent sig is not on file.',
  );
  ...
  public function doValid($value, $context = null) {
      ...
      $test1 = (!is_null($context['parent_sig_1_on_file_p7']) && 0===intval($context['parent_sig_1_on_file_p7']))?true:false;
      $test2 = (!is_null($context['parent_sig_2_on_file_p7']) && 0===intval($context['parent_sig_2_on_file_p7']))?true:false;
    if(($test1 || $test2) && ''==$context['parent_sig_on_file_explain_p7']) {
        $this->_error(self::SIG_NOT_ON_FILE);
        return false;
    }
    return true;
  }
