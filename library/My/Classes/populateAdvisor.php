...
{ 
class My_Classes_populateAdvisor {
  ...
  public function advisorsetAction($id_county=0,$id_district=0) {
    ...
    //  $this->writevar1($districtStudents,'this is a list of the districts studetns');
      ...
      $advisorStudentData='';
      $advisorStudentData['educationOrganizationID']=$student['id_county'].$student['id_district'].$student['id_school'];
      ...
      */
      ...
      if($stuId=='1164586'){
      //    $this->writevar1($mostRecentMdt,'the most recent mdt');
      //   $this->writevar1($mostRecentMdtCard,' the most recent mdtcard');
      }
       ...
       if($mostRecentMdt!=null && $mostRecentMdtCard!=null ){
           ...
           if ($stuId=='1164586') {
            //  $this->writevar1($mostRecentMdt[0],'this is when MDT is not null as well as the card');
              // $this->writevar1($result['beginDate'],'this is the begin date');
           }
      }
    ...
    if (($mostRecentIfsp!=null || $mostRecentIep!=null || $mostRecentIepCard!=null)
      ...
      $advisorStudentData['serviceBeginDate_slt']=null;
       ...
       if (($mostRecentIfsp!=null || $mostRecentIep!=null || $mostRecentIepCard!=null)
           && $continue==true && $advisorStudentData['studentUniqueID']>='1000000000') {
