...
abstract class My_Form_AbstractFormController extends App_Zend_Controller_Action_Abstract {
	...
	public function finalizeAction() {
		...
		$this->writevar1($request,'this is the request line 388');
...
//		}
	...
	function replaceSessionImages($url) {
		...
		return '<img class="form010Chart" src="http://iepweb02d.nebraskacloud.org/temp/' . substr ( $url [1], strrpos ( $url [1], '/' ) + 1 ) . '.png">';
	}
