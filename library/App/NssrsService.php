...
class App_NssrsService
{
    ...
    public function buildTransfersDatatable($request, $columns)
    {
        ...
        // get count of found records
        $searchCount = isset($searchResults[3]) ? $searchResults[3] : 0;
        ...
        $recordsFiltered = count($this->returnRows);
        ...
        if($this->nssrsError || $transferError) {
            ...
            return array(
                ...
                "recordsFiltered" => isset($searchCount) ? $searchCount : $recordsFiltered,
...
// get the filtered number of records
    ...
    private function buildNssrsRow($columns, $studentRow, $noText, $noneText)
    {
       ...
       // $this->writevar1($rowData,'this is a row of data');
