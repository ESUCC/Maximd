<?php
class App_Form_Element_TestEditor extends Zend_Form_Element_Textarea
{
...
//
//class App_Form_Element_TestEditor extends Zend_Dojo_Form_Element_Editor
//{
...
//        $this->setAttrib('style', 'width:800px;'); // grey no more // background-color:#dddddd;
//	}
//
//    public function appendAttrib($name, $value)
//	{
...
//
//		//'bold','italic','|',
//		$this->setAttrib('plugins', "['cut', 'copy', 'paste', '|', 'bold', 'italic', 'underline', 'strikethrough', '|', 'insertOrderedList', 'indent', 'outdent', 'justifyLeft', 'justifyRight', 'justifyCenter', 'justifyFull']");
...
//		}
//
//		$this->addFilter(new App_Filter_TestWordFilter());
//
//        // default validation - do not allow empty
//        $this->setAllowEmpty(false);
//        $this->setRequired(true);
