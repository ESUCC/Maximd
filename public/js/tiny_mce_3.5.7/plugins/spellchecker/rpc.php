...
if (isset($importConfig['general.remote_rpc_url'])) {
	$url = parse_url($importConfig['general.remote_rpc_url']);
...
// Execute RPC
if (isset($importConfig['general.engine'])) {
	$spellchecker = new $importConfig['general.engine']($importConfig);
