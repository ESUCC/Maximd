...
//                        save(evt, false, "/form"+form_num+"/jsonupdateiep");                    
    			...
    			if('View Student' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=view';
    				
    			} else if ('Edit Student' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=edit';
    				
    			} else if ('Student Charting' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=charting';
    				
    			} else if ('Parent/Guardians' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=parents';
    				
    			} else if ('Student Team' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=team';
    				
    			} else if ('Student Forms' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=forms';
    				
    			} else if ('Student Log' == studentOptions.value) {
    				window.location.href='https://iep.nebraskacloud.orgu/srs.php?area=student&sub=student&student='+dojo.byId('id_student').value+'&option=log';
    			}
