...
if(!dojo._hasResource["soliant.editor.plugins.ProcessContent"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["soliant.editor.plugins.ProcessContent"] = true;
dojo.provide("soliant.editor.plugins.ProcessContent");

dojo.require("dijit._editor._Plugin");
dojo.require("dijit._editor.html");

dojo.experimental("soliant.editor.plugins.ProcessContent");

dojo.declare("soliant.editor.plugins.ProcessContent",dijit._editor._Plugin,{
	//	summary:
	//		This plugin provides ProcessContent cabability to the editor.  It is
	...
	setEditor: function(editor){
		...
		// srs processing	
		this.editor.contentDomPostFilters.push(dojo.hitch(this, this._convertLineBreaks));
	...
	// jlavere additions
	_convertLineBreaks: function(html){
		// summary: 
		//		A function to handle normalizing certain tag types contained under 'node'
		// node:
		//		The node to search from.
		// tags:
		//		Protected.
		console.debug('_convertLineBreaks', html);
		if(html){
			var div = this.editor.document.createElement("div");
			div.innerHTML = html;
			div = this._browserFilter(div);
...
dojo.subscribe(dijit._scopeName + ".Editor.getPlugin",null,function(o){
	...
	if(name === "processcontent"){
		o.plugin = new soliant.editor.plugins.ProcessContent({
