...
if(!dojo._hasResource["soliant.widget.FileUploader"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["soliant.widget.FileUploader"] = true;
