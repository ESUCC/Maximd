...
if(!dojo._hasResource["soliant.widget.FileList"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
dojo._hasResource["soliant.widget.FileList"] = true;
