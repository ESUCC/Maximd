...
$().ready(function() {
	$(":radio[name='attend']").change(function() {
		$(":radio[name='attend_no_response']").prop('checked', false);
	});
	
	$(":radio[name='attend_no_response']").change(function() {
		$(":radio[name='attend']").prop('checked', false);
	});
});
