    ...
    static public function archiveFormToPdf(
        ...
        try {
            ...
            if ($dbData['version_number'] >= 9) {
                ...
                // old site
                $url = 'https://iep.unl.eduu/form_print.php?form=form_' . $formNumber . '&document=' . $document . '&archive=true';
                if (!isset($sid)) {
            ...
            if ($dbData['version_number'] >= 9) {
                ...
                $cookie = new Zend_Http_Cookie('PHPSESSID-ARCHIVE', $sid, 'iep.unl.eduu');
            }
