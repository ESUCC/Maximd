...
/usr/local/zend/bin/php -d include_path='/usr/local/zend/var/libraries/Zend_Framework_1/1.12.16/library/:/usr/loca/zend/share/pear/' -d extension_dir='/usr/local/zend/lib/php_extensions/' -d enable_dl=On -d extension=pgsql.so -d extension=pdo_pgsql.so /usr/local/zend/var/apps/https/iepweb02.nebraskacloud.org/80/1.0.0_84/scripts/cron/moveGRTFilesToFolder.php -e iepweb03  -n 004 -b 1/1/2016
